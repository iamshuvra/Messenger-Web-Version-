...
while($row = $result->fetch_assoc()) {
	$syn .= '<div id="no-of-questions"  class="question-faq '.$row['faq_que_id'].'"><h4>'.$row['question_text'].'</h4>';
	...
	$syn .= '<div id="button-on-faq-sec"><button class="'.$row['faq_que_id'].'"<button id="faq-showmore-btn" class="'.$row['faq_que_id'].'">Show more</button></div></div>';
	$i++;
}
